...
var ministries_1 = require("./src/services/ministries");
var ministries = [
    {
        name: 'Choir Ministry',
...
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, ministries_2, m, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('Starting seed...');
                    _i = 0, ministries_2 = ministries;
                    _a.label = 1;
                case 1:
                    if (!(_i < ministries_2.length)) return [3 /*break*/, 6];
                    m = ministries_2[_i];
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, ministries_1.addMinistry)(m)];
                case 3:
                    _a.sent();
                    console.log("Added: ".concat(m.name));
                    return [3 /*break*/, 5];
                case 4:
                    e_1 = _a.sent();
                    console.error("Error adding ".concat(m.name, ":"), e_1);
                    return [3 /*break*/, 5];
                case 5:
                    _i++;
                    return [3 /*break*/, 1];

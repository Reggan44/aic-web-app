  ...
  return (
    <div className="min-h-screen bg-background pt-32 pb-20 overflow-x-hidden">
      <SEO
        ...
        url="/about"
        image="/church-compound-view.jpeg"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24 relative">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-brand-sage/5 rounded-full blur-[120px] pointer-events-none -z-10"></div>
        <motion.div 
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-center space-y-8"
        >
          <span className="inline-block px-4 py-1.5 border border-brand-sage/20 bg-brand-sage/5 text-brand-sage text-xs font-bold uppercase tracking-[0.2em] rounded-full">
            Our Vision Theme
          </span>
          <h1 className="text-5xl md:text-7xl font-black text-brand-grey tracking-tighter leading-tight">
            Growing Deeper,<br />
            <span className="text-brand-sage">Living Stronger</span>
          </h1>
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed italic font-serif">
            "Rooted and built up in Him, strengthened in the faith as you were taught and overflowing with thankfulness."
          </p>
          <p className="text-brand-sage/60 font-bold tracking-widest uppercase text-sm">— Colossians 2:7</p>
        </motion.div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24">
            ...
            >
              ...
              <h2 className="text-3xl font-black text-brand-grey tracking-tight mb-6">Our Vision</h2>
            ...
            >
              ...
              <h2 className="text-3xl font-black tracking-tight mb-6 text-white">Our Mission</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-black text-brand-grey tracking-tight">Our Core Values</h2>
          <div className="w-24 h-2 bg-brand-sage mx-auto mt-6 rounded-full"></div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl font-black text-brand-grey tracking-tight">Our Leadership</h2>
        </motion.div>
            ...
            {leaders.map((leader, i) => (
              ...
              >
                <Link to={`/about/pastors/${leader.id}`} className="block h-full group">
                  <div className="bg-white rounded-[3rem] p-8 border border-border shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col items-center text-center h-full relative overflow-hidden">
                    <div className="absolute top-0 w-full h-32 bg-brand-sage/10 -z-10 group-hover:bg-brand-sage/20 transition-colors"></div>
                    
                    <div className="relative w-40 h-40 rounded-full overflow-hidden shadow-xl border-4 border-white mb-6 group-hover:scale-105 transition-transform duration-500 bg-slate-100">
                      <img 
                        src={leader.image} 
                        alt={leader.name} 
                    ...
                    <div className="space-y-2 flex-grow">
                      <h3 className="text-2xl font-black text-brand-grey tracking-tight group-hover:text-brand-sage transition-colors">{leader.name}</h3>
                      <p className="text-brand-sage font-bold uppercase tracking-widest text-xs">{leader.role}</p>
                      <p className="text-muted-foreground leading-relaxed text-sm pt-4">
                        {leader.bio}
                      </p>
                    </div>

                    <div className="mt-8 pt-6 border-t border-border w-full flex items-center justify-center text-brand-sage font-bold text-sm tracking-wide gap-2 group-hover:gap-4 transition-all uppercase">

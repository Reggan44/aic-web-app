    ...
    <div className="bg-background min-h-screen pb-20">
      ...
      <section className="relative px-6 bg-brand-grey overflow-hidden pt-48 pb-24">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-20 pointer-events-none">
          <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-brand-sage rounded-full blur-[140px]"></div>
          <div className="absolute bottom-1/4 left-1/4 w-[600px] h-[600px] bg-brand-sky rounded-full blur-[160px]"></div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 space-y-8">
          ...
          >
            ...
            <p className="text-white/60 text-lg md:text-xl font-light italic max-w-2xl mx-auto leading-relaxed">
              Whether you have a question, a prayer request, or want to learn more about our mission family, we're here for you.
            </p>
          </motion.div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 mt-[-40px] relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="bg-white p-10 rounded-[2rem] border border-slate-100 shadow-2xl space-y-10 group">
                <div className="flex items-start gap-6">
                  <div className="w-12 h-12 rounded-xl bg-brand-sage/5 border border-brand-sage/10 text-brand-sage flex items-center justify-center shrink-0">
                    <MapPin size={22} />
                  </div>
                  <div>
                    <h3 className="text-[10px] font-semibold text-brand-sage uppercase tracking-[0.2em] mb-2" style={{ fontFamily: "'Montserrat', sans-serif" }}>Visit Our Mission</h3>
                    <p className="text-muted-foreground text-sm uppercase font-semibold tracking-tight" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                ...
                <div className="flex items-start gap-6">
                  <div className="w-12 h-12 rounded-xl bg-brand-sky/5 border border-brand-sky/10 text-brand-sky flex items-center justify-center shrink-0">
                    <Mail size={22} />
                  </div>
                  <div>
                    <h3 className="text-[10px] font-semibold text-brand-sky uppercase tracking-[0.2em] mb-2" style={{ fontFamily: "'Montserrat', sans-serif" }}>Digital Dispatch</h3>
                    <p className="text-muted-foreground text-sm font-semibold tracking-tight" style={{ fontFamily: "'Montserrat', sans-serif" }}>aichappyvalley@gmail.com</p>
                  </div>
                </div>

                <div className="flex items-start gap-6">
                  <div className="w-12 h-12 rounded-xl bg-brand-gold/5 border border-brand-gold/10 text-brand-gold flex items-center justify-center shrink-0">
                    <Phone size={22} />
                  </div>
                  <div>
                    <h3 className="text-[10px] font-semibold text-brand-gold uppercase tracking-[0.2em] mb-2" style={{ fontFamily: "'Montserrat', sans-serif" }}>Voice Comm</h3>
                    <p className="text-muted-foreground text-sm font-semibold tracking-tight" style={{ fontFamily: "'Montserrat', sans-serif" }}>+254 700 000 000</p>
                  </div>
                </div>
            </div>
          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-8 md:p-14 rounded-[2rem] border border-slate-100 shadow-2xl h-full font-sans relative overflow-hidden group">
              {/* Form Glow Bar */}
              ...
              <h2 className="text-3xl font-semibold text-brand-grey uppercase tracking-tight mb-12" style={{ fontFamily: "'Montserrat', sans-serif" }}>Mission Message</h2>
